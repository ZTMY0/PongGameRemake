...
public:
    ...
    void DrawStartMenu() {
        DrawText("Welcome to Undertale PingPong!", screenWidth / 2 - 300, screenHeight / 2 - 50, 40, gc.Purple5);
        DrawText("Press SPACE to Start", screenWidth / 2 - 150, screenHeight / 2 + 10, 20, gc.Purple5);
    }
    ...
    void GameLoop() {
        ...
        ballTexture = LoadTexture("C:/Users/ihabz/Downloads/PongGame/Build/custom_ball.png");
        leftPaddleTexture = LoadTexture("C:/Users/ihabz/Downloads/PongGame/Build/sans_paddle.png");
        rightPaddleTexture = LoadTexture("C:/Users/ihabz/Downloads/PongGame/Build/sans_paddle.png");
        SetTargetFPS(60);

        InitAudioDevice();

        HitSound = LoadSound("C:\\Users\\ihabz\\Downloads\\PongGame\\Build\\hitSound.wav");
        BGMusic = LoadMusicStream("C:\\Users\\ihabz\\Downloads\\PongGame\\Build\\music.mp3");
        Point = LoadSound("C:\\Users\\ihabz\\Downloads\\PongGame\\Build\\point.wav");

        SetSoundVolume(HitSound, 0.2f);
        SetMusicVolume(BGMusic, 0.5f);

        PlayMusicStream(BGMusic);
        background = LoadTexture("C:/Users/ihabz/Downloads/PongGame/Build/undertale.png");
